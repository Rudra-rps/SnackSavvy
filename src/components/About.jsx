...
export default function About(){
        ...
        <>
            ...
            <section className="about-us">
                <div className="content">
                    <h1>What is SavvySnacks?</h1>
                    <p id="txt">
                        SavvySnacks is your ultimate companion for finding the best meals at the most reasonable prices. By comparing real-time dish prices across leading food delivery apps, we make it easy for you to discover value without compromising on quality. 
                    </p>
                    <p>
                        Powered by advanced AI, our platform analyzes prices from various restaurants and renowned food chains, ensuring you always make informed dining choices. With SavvySnacks, enjoy smarter, budget-friendly dining at your fingertips!
                    </p>
  ...
  <div class="cofounder-card align-left">
    <div class="cofounder-image kaartikey"></div>
    <div class="cofounder-info">
      <h2>Kaartikey Kusshwaha</h2>
      <p>A first-year B.Tech student at VIPS, IP University, New Delhi, Kaartikey is an aspiring technologist passionate about innovation and problem problem-solving. Kaartikey is actively building expertise in web development and Java, with hands-on practice on platforms like LeetCode.</p>
<p>Proficient in HTML, CSS, Java, and C, Kaartikey also has skills in design tools like Adobe Illustrator and Canva, combining technical knowledge with creative design to deliver impactful user experiences. </p>
    </div>
  </div>
  ...
  <div class="cofounder-card align-right">
    ...
    <div class="cofounder-info">
      ...
      <p>A first-year B.Tech student at VIPS, IP University, New Delhi, Atharva is a dedicated learner with a growing interest in web development and backend technologies. Proficient in C++ with hands-on problem-solving experience on LeetCode, he is building a strong foundation in modern web development.</p>
       ...
       <p> Atharva's technical expertise includes HTML, CSS, and backend technologies like Node.js, showcasing his versatility in both frontend and backend development.</p>
    </div>
  </div>
</div>
        </>
